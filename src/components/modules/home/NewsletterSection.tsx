    ...
    <section className="py-24 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <motion.div 
            ...
            viewport={{ once: true }}
            className="relative rounded-[3.5rem] bg-zinc-950 p-12 md:p-20 overflow-hidden text-center shadow-3xl"
        >
            {/* Background elements */}
            ...
            <div className="relative z-10 max-w-2xl mx-auto space-y-10">
                <div className="space-y-4">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-xl text-white/80 text-[10px] font-black uppercase tracking-[0.4em]"
                    >
                    ...
                    <motion.p
                        ...
                        className="text-white/40 text-lg font-medium italic"
                    >
                ...
                <motion.form
                    ...
                    className="flex flex-col sm:flex-row items-center gap-4 bg-white/5 p-2 rounded-[2rem] border border-white/10 backdrop-blur-md"
                >
                    <div className="relative flex-1 w-full flex items-center px-6 gap-4">
                        <Mail className="text-white/20" size={24} />
                        <input
                            type="email"
                            required
                            ...
                            className="bg-transparent border-none outline-none text-white w-full h-14 font-bold placeholder:text-white/20"
                        />
                    </div>
                    <button
                        type="submit"
